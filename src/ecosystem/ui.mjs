...
export function renderConnectionPage(
  ...
  </style></head><body><a class="skip" href="#main">Skip to content</a><header><a class="brand" href="/">Bittrees MCP</a><nav aria-label="Primary"><a href="/connect" aria-current="page">Connect</a><a href="/connect#available">Projects</a><a href="/status">Status</a><a href="https://agent.bittrees.org">Agent onboarding</a></nav></header><main id="main"><p class="badge">One gateway · public project context</p><h1>Choose your projects. Connect your agent.</h1><p>Discover project documentation, integration status, and reviewed handoff routes. Private accounts and product actions need separate project authorization.</p>
